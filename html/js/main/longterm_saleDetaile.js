...
define(function(require){
  ...
  var login = require("../module/login.js"),
    ...
    var loneDetaile = {
      ...
      marketingright:null,
      // Ajax加载数据
      getSaleData:function(marketingright){
        var _this = this;
        $.ajax({
          type:"get",
          url:urlPath + '/web/marketing/right/info?marketingright='+marketingright,
          dataType: 'json',
          
          success:function(res){
            console.log(res);
            var DetaileCard = '';
            DetaileCard+=' <div class="fl" id="picContainer">';
            ...
            DetaileCard+='<h4>'+ res.data.title +'<i class="btn-edit"></i></h4>\
                      </div>\
                      <ul>\
                      ...
                      <div style="display:block; position:absolute; top:338px;">\
      ...
      scrollTab:function(){
        ...
        var arr = [];
        arr.push(decTop,picTop,processTop);
