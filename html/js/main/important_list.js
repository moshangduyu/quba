...
define(function (require) {
    ...
    urlParams.get("catalog") || urlParams.set("catalog", "");
        ...
        $.get(baseUrl + "/web/content/contents", {
            ...
            if(res.data.rows.length > 0){
                ...
                res.data.rows.forEach(function (e) {
                    ...
                    list.push(
                        '<li class="go-href" style="cursor: pointer;">'+
                        ...
                        '        <a href="important_detaile.html?id='+ e.id + '&catalog='+ urlParams.get("catalog") +'">' + e.title +'</a>'+
        ...
        $.get(baseUrl + "/web/content/contents", {
            ...
            if(res.status === 0){
                ...
                var tops = res.data.rows.map(function (e) {
                    ...
                    return $("<li><a href='important_detaile.html?id="+e.id+"&catalog=" + catalog +"'>" + e.title + "</a></li>")
